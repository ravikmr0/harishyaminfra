...
export default function ShriHariVatikaPhase2() {
  const projectDetails = {
    id: 'shri-hari-vatika-phase-2',
    title: 'Shri Hari Vatika Phase-2',
    subtitle: 'Extended luxury development with larger plot options',
  ...
  const specifications = [
    { label: 'Plot Sizes', value: '100-150 Gaj', icon: Home },
    { label: 'Price Range', value: 'Rs 18 Lac*', icon: DollarSign },
    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Phase 2 offers expanded plot options with enhanced infrastructure. It's designed for discerning buyers looking for premium residential living with investment potential.
              </p>
            </div>
          ...
          <div className="bg-gradient-to-br from-[#f8f9fa] to-white p-8 rounded-lg border-2 border-[#b26243]">
            ...
            <p className="text-gray-700 mb-6">
              Phase 2 represents an exceptional investment opportunity with larger plot options and enhanced amenities. The expanded release provides better choices for diverse investor profiles.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-[#b26243]">Rs 12,000/month</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                { title: 'Prime Pocket', desc: 'Extended prime residential pocket with growth potential' },
                { title: 'Connectivity', desc: 'Excellent connectivity to commercial and educational hubs' },
                { title: 'Infrastructure', desc: 'Modern infrastructure with all essential amenities' },
              ].map((item, idx) => (
      ...
      <section className="bg-gradient-to-r from-[#1a2332] to-[#2d3e50] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4 font-playfair">Ready to Invest in Phase-2?</h2>
