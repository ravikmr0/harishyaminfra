...
export default function Services() {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section id="services-hero" className="section-shell-hero bg-gradient-to-r from-[#1a2332] to-[#2c3e50] text-white">
      ...
      {/* Services Grid */}
      <section id="service-offerings" className="section-shell bg-white">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 card-grid">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-5 border-t-4 border-[#b26243]"
      ...
      {/* CTA Section */}
      <section id="services-cta" className="section-shell-tight bg-gradient-to-r from-[#b26243] to-[#8d4a33]">
