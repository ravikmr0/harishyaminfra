    ...
    <div className="bg-white">
      ...
      <section className="section-shell-hero bg-gradient-to-r from-[#1a2332] to-[#2c3e50] text-white">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-4 font-playfair">Brochures & Downloads</h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 card-grid">
            {brochures.map((brochure, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border-t-4 border-[#d4af37]">
                  ...
                  <p className="text-gray-600 mb-5 text-sm">{brochure.description}</p>
